#!/usr/bin/env python3
"""Fizz. · latas gaseosa de cacao (patrón DAYDRINK: blanco + dúo + CACAO & X)."""
...
<svg xmlns="http://www.w3.org/2000/svg" width="{w}mm" height="{h}mm" viewBox="0 0 {w*10} {h*10}"
  role="img" aria-label="Fizz. CACAO &amp; {pair}">
  <title>Fizz. · CACAO &amp; {pair}</title>
  ...
  <g id="ARTWORK">
    ...
    <!-- Wordmark Fizz. -->
    <g id="WORDMARK">
      <text x="44" y="148" font-family="Bodoni Moda, Didot, Georgia, serif" font-size="72" font-style="italic" font-weight="900" fill="{SHADOW}">Fizz.</text>
      <text x="40" y="144" font-family="Bodoni Moda, Didot, Georgia, serif" font-size="72" font-style="italic" font-weight="900" fill="{NAVY}">Fizz.</text>
    </g>
...
def main():
    for sku in SKUS:
        write_both(Path(f"fizz-{sku['id']}-can.svg"), can_front(sku))

    readme = """# Fizz. · gaseosa de cacao
...
| SKU | Archivo |
|-----|---------|
| Limón | `fizz-limon-can.svg` |
| Naranja | `fizz-naranja-can.svg` |
| Maracuyá | `fizz-maracuya-can.svg` |
| Jamaica | `fizz-jamaica-can.svg` |

```bash
python3 brand/chocolate-benevolo/packaging/build_fizz_cans.py
```
"""
    (OUT / "README.md").write_text(readme, encoding="utf-8")
    (PUBLIC / "fizz" / "README.md").write_text(readme, encoding="utf-8")
    print("done")
