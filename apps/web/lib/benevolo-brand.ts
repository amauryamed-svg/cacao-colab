...
export const benevoloFormulation = {
  ...
  netWeight: "80 g",
  style: "Chocolate de leche con marañón sugar free · duja solo como técnica",
  inspiration: "Base leche (no gianduja commodity). Marañón como fruto + duja como pasta. Antojo con rigor.",
