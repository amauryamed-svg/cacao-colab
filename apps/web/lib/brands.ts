...
export const brands: Brand[] = [
  ...
  },
  {
    ...
    description:
      "Nodo del Colab en Tame ligado al material FEAR 5. Origen del cacao del capstone Chocolate Benevolo en Master Chocolatier y puente al laboratorio de fermentación.",
    location: "Tame, Arauca",
    territoryId: "arauca",
    accentColor: "#E3A12B",
    bgColor: "#402812",
    textColor: "#F7F1EE",
    products: ["FEAR 5 · Arauca", "Fermentación aplicada", "Origen Benevolo"],
    ctaLabel: "Conectar con el nodo →",
  ...
  },
  {
    ...
    tagline: "Output Master Chocolatier · lente COEX.",
    description:
      "Capstone bean-to-bar: duja de marañón, leche orgánica, alulosa y stevia sobre FEAR 5 de Quara Cacao. Alianza Zurych × Quara. Preventa en ChocolateBenevolo.co.",
    location: "Arauca · Master Chocolatier",
    territoryId: "arauca",
    accentColor: "#E8C9A0",
    bgColor: "#1A120C",
    textColor: "#F7F1EE",
