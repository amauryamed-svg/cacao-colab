...
/** Ardilla Dualita — expresiones para reacciones Duolingo-like. */
  ...
  return (
    ...
    >
      <g className="squirrel-tail">
        <path
          d="M 36,92 C 4,77 0,43 17,26 C 27,13 50,19 46,40 C 43,53 35,63 39,75 C 42,83 40,89 36,92 Z"
          fill="#C8A010"
        />
        <path
          d="M 36,89 C 8,75 4,44 19,28 C 28,17 48,23 44,42 C 42,53 35,62 39,73 C 42,80 40,86 36,89 Z"
          fill="#F2C830"
        />
        <path
          d="M 35,84 C 12,72 9,46 22,31 C 30,21 46,26 43,43 C 41,52 35,61 39,71 Z"
          fill="#F7DE50"
          opacity="0.36"
        />
        <ellipse
      ...
      <g className="squirrel-pod" style={{ transformOrigin: "100px 76px" }}>
      ...
      {expression === "proud" && (
        <g className="squirrel-sparkles" opacity="0.9">
          <circle cx="48" cy="18" r="2" fill="#F2C830" />
          <circle cx="88" cy="14" r="1.5" fill="#F7DE50" />
          <circle cx="42" cy="52" r="1.4" fill="#FFFFFF" opacity="0.7" />
        </g>
      )}
    </svg>
  )
