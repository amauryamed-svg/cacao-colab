...
/** Pantalla cuando el Master aún no está abierto por rango. */
export default function MasterAccessGate({ title, access }: Props) {
  return (
    <div className="min-h-screen bg-[#101d0b] text-colab-cream px-4 py-16">
      <main className="max-w-xl mx-auto">
        <p className="eyebrow text-colab-yellow">Master · acceso por rango</p>
        ...
        <div className="mt-8 rounded-2xl border border-colab-yellow/25 bg-colab-yellow/10 p-5">
          <p className="text-sm font-bold text-colab-yellow">Aún no disponible</p>
